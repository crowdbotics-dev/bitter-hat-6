"""
Django settings for bitter_hat_6 project.
...
ROOT_URLCONF = 'bitter_hat_6.urls'
...
WSGI_APPLICATION = 'bitter_hat_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_hat_6 API",
    "DESCRIPTION": "API documentation for bitter_hat_6 App",
    "VERSION": "v1",
}
